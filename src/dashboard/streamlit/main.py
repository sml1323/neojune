...
from app_pages import dashboard, company_data, company_analyze, university_data, legal_status, report, university_analyze
...
with st.sidebar:
    page = option_menu(
            "",  # 메뉴 제목(생략)
            ["Dashboard", "법적 상태", "기업 분석","대학 분석", "Report", "기업", "대학교"],  
            icons=['house', 'bi bi-book', 'bi bi-pie-chart', 'bi bi-pie-chart', 'bi bi-bar-chart-line', 'bi bi-building', 'bi bi-mortarboard'],  # 아이콘 추가
...
if page == "Dashboard":
    ...
    university_analyze.display_university_analyze()
elif page == "대학교":
